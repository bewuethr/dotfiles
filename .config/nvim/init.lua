...
-- Customize visible whitespace characters
...
vim.keymap.set('n', '<C-S-j>', '<C-w>J', { desc = 'Move window up' })
vim.keymap.set('n', '<C-S-k>', '<C-w>K', { desc = 'Move window down' })
...
-- Format Go file and update imports when saving
...
require('lazy').setup {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('grt', require('telescope.builtin').lsp_type_definitions, '[G]oto Type [D]efinition')
  ...
  --
  -- For additional information, see `:help lazy.nvim-🔌-plugin-spec` or use
  -- `<leader>sh` for telescope and search for `lazy.nvim-plugin`
